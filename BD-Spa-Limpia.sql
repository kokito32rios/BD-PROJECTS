...
CREATE DATABASE
IF NOT EXISTS spa_unas CHARACTER
SET utf8mb4
...
CREATE TABLE
IF NOT EXISTS horarios_trabajo
(
    id INT AUTO_INCREMENT PRIMARY KEY,
    email_manicurista VARCHAR
(100) NOT NULL,
    dia_semana TINYINT NOT NULL CHECK
(dia_semana BETWEEN 1 AND 7), -- 1=lunes
...
CREATE TABLE
IF NOT EXISTS excepciones_horario
(
    id INT AUTO_INCREMENT PRIMARY KEY,
    email_manicurista VARCHAR
(100) NOT NULL,
...
(20) DEFAULT NULL,
    estado ENUM
('pendiente', 'confirmada', 'completada', 'cancelada', 'no_asistio') DEFAULT 'pendiente',
    precio DECIMAL
(10, 2) NOT NULL,
    notas_cliente TEXT,
...
(id_servicio),
    INDEX idx_fecha_estado
(fecha, estado)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- COMISIONES (Configuración anual)
CREATE TABLE
IF NOT EXISTS comisiones_manicuristas
(
    id INT AUTO_INCREMENT PRIMARY KEY,
    email_manicurista VARCHAR
(100) NOT NULL,
...
(10, 2) NOT NULL,
    estado_pago_cliente ENUM
('pendiente', 'pagado', 'reembolsado') DEFAULT 'pendiente',
    estado_pago_manicurista ENUM
('pendiente', 'pagado') DEFAULT 'pendiente',
...
(10, 2) NOT NULL,
    tipo ENUM
('gasto_local', 'deduccion_manicurista', 'insumo', 'personal', 'otro') DEFAULT 'otro',
    email_manicurista VARCHAR
(100),
...
CREATE TABLE
IF NOT EXISTS reportes_manicurista
(
...
-- GALERÍA
CREATE TABLE
IF NOT EXISTS trabajos_imagenes
(
...
INSERT IGNORE
INTO roles
(id_rol, nombre_rol, descripcion) VALUES
...
INSERT IGNORE
INTO servicios
(nombre, precio, duracion_minutos, descripcion) VALUES
