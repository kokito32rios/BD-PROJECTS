...
CREATE TABLE usuarios (
    ...
    FOREIGN KEY (nombre_rol) REFERENCES roles(nombre_rol) 
...
CREATE TABLE excepciones_horario (
    ...
    email_manicurista VARCHAR(255) NOT NULL,
    fecha DATE NOT NULL,
    todo_el_dia TINYINT(1) DEFAULT 1 COMMENT '1=bloquea todo el día',
...
CREATE TABLE pagos (
    ...
    monto_total DECIMAL(10,2) NOT NULL COMMENT 'Precio del servicio (copiado para histórico)',
    comision_manicurista DECIMAL(10,2) NOT NULL COMMENT 'Calculada: monto_total * porcentaje/100',
    estado_pago_cliente VARCHAR(20) NOT NULL DEFAULT 'pendiente' 
        CHECK (estado_pago_cliente IN ('pendiente', 'pagado', 'reembolsado')),
    estado_pago_manicurista VARCHAR(20) NOT NULL DEFAULT 'pendiente' 
        CHECK (estado_pago_manicurista IN ('pendiente', 'pagado')),
...
CREATE TABLE trabajos_imagenes (
    ...
    url_imagen VARCHAR(500) NOT NULL COMMENT 'Ruta relativa ej: /uploads/trabajo-123.jpg',
    descripcion TEXT DEFAULT NULL,
...
ADD COLUMN imagen_principal TINYINT(1) DEFAULT 0 
...
SELECT * FROM trabajos_imagenes;

USE spa_unas;

INSERT INTO trabajos_imagenes (id_servicio, url_imagen, descripcion, activo, orden) VALUES
(1, '/uploads/manicura-tradicional.jpg', 'Manicura clásica francesa', 1, 1),
(1, '/uploads/manicura-gel.jpg', 'Esmalte gel color nude', 1, 1),
(1, '/uploads/pedicura-spa.jpg', 'Pedicura relajante con exfoliación', 1, 1),
(1, '/uploads/unas-acrilicas.jpg', 'Uñas acrílicas con diseño elegante', 1, 1),
(2, '/uploads/diseno-unas.jpg', 'Nail art personalizado', 1, 1),
(3, '/uploads/kapping-gel.jpg', 'Acabado natural brillante', 1, 1);

USE spa_unas;

-- CREAR HORARIOS DE TRABAJO PARA LA MANICURISTA
-- Lunes a Viernes: 8:00 AM - 6:00 PM
INSERT INTO horarios_trabajo (email_manicurista, dia_semana, hora_inicio, hora_fin, activo) VALUES
('manicurista@spa.com', 1, '08:00:00', '18:00:00', 1), -- Lunes
('manicurista@spa.com', 2, '08:00:00', '18:00:00', 1), -- Martes
('manicurista@spa.com', 3, '08:00:00', '18:00:00', 1), -- Miércoles
('manicurista@spa.com', 4, '08:00:00', '18:00:00', 1), -- Jueves
('manicurista@spa.com', 5, '08:00:00', '18:00:00', 1), -- Viernes
('manicurista@spa.com', 6, '09:00:00', '14:00:00', 1)  -- Sábado (medio día)
...
CREATE TABLE IF NOT EXISTS gastos (
    ...
    email_manicurista VARCHAR(255) DEFAULT NULL COMMENT 'Solo si es deducción a una manicurista específica',
...
COMMENT='Gastos operativos del local y deducciones a manicuristas';
-- =============================================
-- 11. CIERRES DE CAJA
-- =============================================
CREATE TABLE IF NOT EXISTS cierres_caja (
    ...
    total_pagado_manicuristas DECIMAL(10, 2) DEFAULT 0 COMMENT 'Suma de comisiones pagadas en este periodo',
    
    -- Balance
    balance_final DECIMAL(10, 2) DEFAULT 0 COMMENT 'Ingresos - Gastos - Pagos Manicuristas',
...
COMMENT='Histórico de cierres de caja (diarios o semanales)';-- =============================================
-- CREAR LA BASE DE DATOS
-- =============================================
CREATE DATABASE
...
WHERE id_imagen IN
    ...
    SELECT *
        ...
        SELECT MIN(id_imagen)
                                ...
                                INSERT INTO horarios_trabajo
                                    (email_manicurista, dia_semana, hora_inicio, hora_fin, activo)
                                VALUES
                                    ('manicurista@spa.com', 1, '08:00:00', '18:00:00', 1),
                                    -- Lunes
                                    ('manicurista@spa.com', 2, '08:00:00', '18:00:00', 1),
                                    -- Martes
                                    ('manicurista@spa.com', 3, '08:00:00', '18:00:00', 1),
                                    -- Miércoles
                                    ('manicurista@spa.com', 4, '08:00:00', '18:00:00', 1),
                                    -- Jueves
                                    ('manicurista@spa.com', 5, '08:00:00', '18:00:00', 1),
                                    -- Viernes
                                    ('manicurista@spa.com', 6, '09:00:00', '14:00:00', 1)
                                -- Sábado (medio día)
                                ON DUPLICATE KEY
                                UPDATE 
    hora_inicio = VALUES
    ...
    monto DECIMAL
                                (10, 2) NOT NULL,
    tipo ENUM
                                ('gasto_local', 'deduccion_manicurista') NOT NULL,
    email_manicurista VARCHAR
                                (255) DEFAULT NULL COMMENT 'Solo si es deducción a una manicurista específica',
    fecha_gasto DATETIME DEFAULT CURRENT_TIMESTAMP,
...
COMMENT='Gastos operativos del local y deducciones a manicuristas';
    ...
    total_gastos DECIMAL
                                (10, 2) DEFAULT 0,
    total_pagado_manicuristas DECIMAL
                                (10, 2) DEFAULT 0 COMMENT 'Suma de comisiones pagadas en este periodo',
    
    -- Balance
    balance_final DECIMAL
                                (10, 2) DEFAULT 0 COMMENT 'Ingresos - Gastos - Pagos Manicuristas',
